...
@section('content')
    ...
    <div class="card shadow">
        ...
        <div class="card-body border-0">
            <form action="{{route('category.update',$categories -> category_id)}}" method="POST">
                @csrf
                @method('PATCH')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="category_name" type="text" class="form-control @error('category_name') is-invalid @enderror" name="category_name" value="{{$categories -> category_name}}" required autocomplete="category_name" autofocus>
                        @error('category_name')
